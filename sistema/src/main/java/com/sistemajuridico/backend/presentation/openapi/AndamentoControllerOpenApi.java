...
public interface AndamentoControllerOpenApi {
    ...
    @Operation(summary = "Cadastrar andamento processual", description = "Registra um novo andamento ou movimentaÃ§Ã£o vinculada a um processo judicial")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Listar andamentos por processo", description = "Recupera o histÃ³rico cronolÃ³gico de andamentos do processo informado")
    @ApiResponses(value = {
